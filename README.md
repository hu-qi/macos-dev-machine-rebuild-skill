...
[中文文档](./README-zh.md) · [Skill](./skills/macos-dev-machine-rebuild/SKILL.md) · [Security](./SECURITY.md) · [License](./LICENSE)
...
Read [`skills/macos-dev-machine-rebuild/SKILL.md`](./skills/macos-dev-machine-rebuild/SKILL.md) before changing shell, SSH, GPG, Git, or package-manager settings.
...
| [`skills/macos-dev-machine-rebuild/SKILL.md`](./skills/macos-dev-machine-rebuild/SKILL.md) | Canonical instruction source for an AI agent or a manual runbook. |
| [`skills/macos-dev-machine-rebuild/scripts/bootstrap.sh`](./skills/macos-dev-machine-rebuild/scripts/bootstrap.sh) | Non-destructive readiness audit and setup guidance. |
| [`skills/macos-dev-machine-rebuild/scripts/verify.sh`](./skills/macos-dev-machine-rebuild/scripts/verify.sh) | Post-setup validation for system, toolchain, and signing prerequisites. |
| [`skills/macos-dev-machine-rebuild/scripts/export-snapshot.sh`](./skills/macos-dev-machine-rebuild/scripts/export-snapshot.sh) | Exports a minimal environment snapshot without private keys or full Git config. |
...
`skills/macos-dev-machine-rebuild/SKILL.md` is the canonical source of truth. It uses standard YAML frontmatter and an explicit, step-by-step procedure so it can be consumed directly as a Skill or translated into tool-specific instruction formats.
